...
VALUES 
    (uuid_generate_v4(), 'admin@example.com', '$2a$12$nQWbw0fRMUkfHraA8uBeFe6JXaVAEBysa.YVSsBCedm9LnkoMp0gG', 'sales', true, NOW(), NOW()),
    (uuid_generate_v4(), 'customer@example.com', '$2a$12$nQWbw0fRMUkfHraA8uBeFe6JXaVAEBysa.YVSsBCedm9LnkoMp0gG', 'customer', true, NOW(), NOW());
